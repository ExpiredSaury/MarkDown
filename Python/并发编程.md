...
if __name__ == '__mian__':
    ...
    print('主',os.getpid())
    print('主',current_thread().name)#主线程 Main Thread
```
...
if __name__ == '__main__':
    t=Thread(target=task,args=('zhao',))
    t.daemon=True #daemon要写在start前面
    t.start()
    print('主')
...
当知道锁的使用抢锁必须要释放锁，其实在操作锁的时候也容易产生死锁
...
![image-20220829193434693](C:\Users\31812\AppData\Roaming\Typora\typora-user-images\image-20220829193434693.png)
