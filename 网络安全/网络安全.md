...
![image.png](E:\MarkDown\markdown\imgs\d96e604b3cb5acd067fb0bfb1d375a76.png)
...
![image.png](E:\MarkDown\markdown\imgs\d492092b4ef17cb028d290f00e2f4897.png)
...
![image.png](E:\MarkDown\markdown\imgs\4d1576f2611b7748f226212e025a4968.png)
...
[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-giiondM1-1660485066690)(file:///C:\Users\ADMINI~1\AppData\Local\Temp\ksohtml7452\wps4.jpg)]![image.png](E:\MarkDown\markdown\imgs\287d90baea42b24fd3c7c635332cb90d.png)
...
[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-eYDYxpwm-1660485066692)(file:///C:\Users\ADMINI~1\AppData\Local\Temp\ksohtml7452\wps5.jpg)]![image.png](E:\MarkDown\markdown\imgs\82140ac99a68624174208eb4ae9a3e1f.png)
...
![image.png](E:\MarkDown\markdown\imgs\a2dc92f57ecbad869aeb459230c30d98.png)
...
3. 设置权限**防止资源被篡改，删除**
   ...
   ![image.png](E:\MarkDown\markdown\imgs\49dd704fa3b31e53dce26f31491d61ef.png)
...
![image.png](E:\MarkDown\markdown\imgs\20669753b7b573014484aa3125133260.png)
...
2. 可靠性
   ...
   **2.2访问控制列表**（设置权限）
   ...
   ![image.png](E:\MarkDown\markdown\imgs\572f3fea62187c98f86f99206f0233a6.png)
3. 磁盘利用率
...
![image.png](E:\MarkDown\markdown\imgs\11a23342ea04c5f9006f708d3cf2ef92.png)
...
![image.png](E:\MarkDown\markdown\imgs\d42f63188291a1e8ed21aa1c902967cf.png)
...
![image.png](E:\MarkDown\markdown\imgs\c3fbc8c9024c891bc7fba4194c225bd4.png)
...
![image.png](E:\MarkDown\markdown\imgs\5f584f1b33183aaa50ac2f360eee5e71.png)
...
![image.png](E:\MarkDown\markdown\imgs\6643c0ebe7729026081006e69694fe73.png)
...
![image.png](E:\MarkDown\markdown\imgs\793b0750c6aad6debb4697e58376fba6.png)

**步骤二**

![image.png](E:\MarkDown\markdown\imgs\d239519cc2ae0e6c05925ee5404c1d28.png)

**步骤三**

![image.png](E:\MarkDown\markdown\imgs\2e28b8be082077f86f3595d4c8a7f8d4.png)
...
![image.png](E:\MarkDown\markdown\imgs\045aa32d86fd5b36307e76ce2882f6d9.png)

步骤二

我这个是已经创建好了的

![image.png](E:\MarkDown\markdown\imgs\07f2a7f87eb90c588cf2220e08586520.png)

步骤三

点击新建作用域后先**添加作用域名称，然后设置IP范围**

![image.png](E:\MarkDown\markdown\imgs\e521850820b83c44a35610f2fdb13cd1.png)

添加排除IP地址，就是在自动分配的时候不会选此IP地址

![image.png](E:\MarkDown\markdown\imgs\65eebdb9244a186fae20f7716b028d64.png)

设置租约期限

![image.png](E:\MarkDown\markdown\imgs\69d238d4832cdedff75dfdbb51aec8f2.png)

上面点击下一步之后，点击是，前面我们已经配置了IP地址，子网掩码，

还有网关和DNS没有配置

![image.png](E:\MarkDown\markdown\imgs\0c503061b7700daf71c59fd97049b8f2.png)

设置网关，一般都是254，点击添加

![image.png](E:\MarkDown\markdown\imgs\966dff904ccdc55932485bf6353a5c5a.png)

设置DNS服务器，我们直接在IP地址上写入DNS的IP，点击添加

![image.png](E:\MarkDown\markdown\imgs\6591016f9044dac016929a452be88365.png)

点击下一步后将会遇到这个服务器，我们可以不用管，直接下一步，这个服务器比较老，现在都不用，都用DNS服务器，所以我们直接下一步，

![image.png](E:\MarkDown\markdown\imgs\6d9731c355587a5820822621134a6b5f.png)

激活作用域

![image.png](E:\MarkDown\markdown\imgs\090e7d8650375f6f96e2accab8d241a9.png)
...
![image.png](E:\MarkDown\markdown\imgs\e3194e8e5593f98551416c5c180f1841.png)

取得客户机的物理地址（MAC地址）

![image.png](E:\MarkDown\markdown\imgs\39e036e1896971511d3f395a16f43dc0.png)
...
![image.png](E:\MarkDown\markdown\imgs\f8d5cb258a70f1a80b3ee3dcc67a47cc.png)

我的d盘下已经备份好了一个叫dhcp-backup的文件夹

![image.png](E:\MarkDown\markdown\imgs\07530db609f880dc92c23442be5b2174.png)
...
* **步骤1**写好的网页放在文件夹里，我这里有四个写好的网页
  ...
  ![image.png](E:\MarkDown\markdown\imgs\ca134767faddaf55c29427890b9a1db2.png)
* **步骤2：**
* **步骤3：**![image.png](E:\MarkDown\markdown\imgs\274c602a56f26860212541ad1e67b750.png)

![image.png](E:\MarkDown\markdown\imgs\d8c3b4e4257c1a1ac29ab553e512aa1d.png)

* **步骤4**选择网站存放的路径，

![image.png](E:\MarkDown\markdown\imgs\1c66d6079adcd6e09bb95fedf4a406a5.png)

* **步骤5**这一步不用变，直接下一步，直到点击完成

![image.png](E:\MarkDown\markdown\imgs\dac0e97d001d099afb754115454dca2d.png)

* **步骤6**点击添加好的站点，右键属性

![image.png](E:\MarkDown\markdown\imgs\eea1998ee0eae7c38d4fb00d2529fafd.png)

![image.png](E:\MarkDown\markdown\imgs\ba3b36e8f6c0e738f8a1837ddc837fb2.png)

![image.png](E:\MarkDown\markdown\imgs\4eb45fbd73c2378cc72a8655c77892d6.png)

添加好后，一定要把添加的float.html点击上移，移动到最上面，然后点击确定

* **步骤7**:打开客户端，打开浏览器，地址栏输入 `http://10.1.1.2/`回车就可以访问到服务器发布的网站

![image.png](E:\MarkDown\markdown\imgs\6231a4ae40aa277823425b6d87e25010.png)
...
![image.png](E:\MarkDown\markdown\imgs\d9dd190c181c9a1dedce8b64958a8f26.png)

![image.png](E:\MarkDown\markdown\imgs\bfabe803bd4cfff0dbb0e8c920268bc8.png)
...
![image.png](E:\MarkDown\markdown\imgs\bcd7e3ec60b517d1ec57281a4445a3b3.png)

一路下一步，点击完成就可以

![image.png](E:\MarkDown\markdown\imgs\ecfee10cffe6e50ef31884b00224853b.png)

注意一定要配IP地址，跟新建网站的IP地址一样

然后点击添加 的网站

![image.png](E:\MarkDown\markdown\imgs\3ddfd2f462d5c813d845020b4ee301e4.png)

![image.png](E:\MarkDown\markdown\imgs\717c6bfb6bd9918ab5c144f4c99aad27.png)

点击确定，就可以在客户端以域名的方式访问网站

**其实可以在每次新建网站的时候把设置好的域名加进去，就可以**

![image.png](E:\MarkDown\markdown\imgs\95fcf70a9079ec3d49784b0cfbaa6eec.png)
...
![image.png](E:\MarkDown\markdown\imgs\d5fa47440e9525846abd931dbae894c7.png)

**添加动态网站要开启这个扩展服务**

![image.png](E:\MarkDown\markdown\imgs\0e7fcfc1f5e12c43eed50be28a63c646.png)
...
![image.png](E:\MarkDown\markdown\imgs\2a1b6d9ea230c86c451cf63464f3d6e1.png)

点击下一步，选择文件夹路径，点击下一步

![image.png](E:\MarkDown\markdown\imgs\75bad7560c4f3c4d563242aa418be3bb.png)

注意：这两个都勾选，然后点击下一步，点击完成就OK了，

有需要可以在NTFS权限设置，因为:**用户最终权限为FTP权限与NTFS权限取交集,**

![image.png](E:\MarkDown\markdown\imgs\50be82414b5b00699f95df152af7f37a.png)

如果之前已经创建了一个站点，那我么新创建的这个 站点就不会正常启动，因为他们用的都是同一个IP，同一个 端口号

![image.png](E:\MarkDown\markdown\imgs\7be42a12cd6a69eab82dda920891ad17.png)

取消匿名链接，不能随便被访问

![image.png](E:\MarkDown\markdown\imgs\2c12c9b1ad3e20611431ea4e5f2a1a82.png)

现在就来设置NTFDS权限，这个是我的FTP路径，已经创建了两个文件，作为测试使用，跟之前学习的NTFS权限一样，**右键属性，点击安全**，可以设置个别用户的访问权限，**记得要点击高级，取消继承哦！！！！**

，![image.png](E:\MarkDown\markdown\imgs\c5c957ea0a0bb5b6c54c17cb2d3175b1.png)

![image.png](E:\MarkDown\markdown\imgs\b5e7550ffc6839a5e1677d67449d5f4f.png)

![image.png](E:\MarkDown\markdown\imgs\65e587125d409358afeaad3da6180fb4.png)

![image.png](E:\MarkDown\markdown\imgs\ada5142286d8bae581cf304441e2fac3.png)

设置好了之后就可以去客户机，打开我的电脑，地址栏输入ftp://10.1.1.1,这里这个地址是在服务器上设置的IP地址，一定要保持一致，回车后，会提示要登陆用户，我创建了两个用户，admin完全控制权限，user2022只有可以读的权限，

![image.png](E:\MarkDown\markdown\imgs\6d777c95aab4c457c1dd524e9f2b58f4.png)
...
![image.png](E:\MarkDown\markdown\imgs\7410ea50f1099c96af57152632866d0c.png)

![image.png](E:\MarkDown\markdown\imgs\198075bed076ad31946165d73b3edf34.png)

一路点击下一步，

![image.png](E:\MarkDown\markdown\imgs\c71fdf147effd603b85b4e28b994f33d.png)

![image.png](E:\MarkDown\markdown\imgs\b05c9489bb4b29e3652a5b147231adcf.png)

![image.png](E:\MarkDown\markdown\imgs\75cd857f2c9a0f8ca4aacbd8132ad5e6.png)

![image.png](E:\MarkDown\markdown\imgs\0b0f68cba636c7c55b8760da4c954246.png)

win2008安装好AD后，就成为了DC，那么本地用户和cesh就不再本地，已经偷偷迁移到活动目录这张表里了，**以前的本地管理员现在变成了域的管理员**

重启后就变成了以**域身份登录**

![image.png](E:\MarkDown\markdown\imgs\7cc6b18a931d6e2567ff5ea79f2c8938.png)

**步骤2：检查验证是否安装成功**

![image.png](E:\MarkDown\markdown\imgs\71aba662be3f934b779aacb5728f4961.png)

![image.png](E:\MarkDown\markdown\imgs\91927106513cc7b5592ec937c44e303c.png)

打开活动目录，**DomainAdmin 域管理员组**

![image.png](E:\MarkDown\markdown\imgs\da1dcd34eeb02f10076c0d9ed02f1f79.png)
...
3. 计算机右键属性--计算机名--更改--加入qf.com域
   ...
   **步骤**：手动配IP，设置DNS指向DC，要做域名解析
   ...
   ![image.png](E:\MarkDown\markdown\imgs\245cff99ae076d8a73700027f5908e7d.png)

   ![image.png](E:\MarkDown\markdown\imgs\1699b3bfbfbc50d7ca4009977bfce79f.png)

   点击确定，会弹出登陆页面
   y用户名也可以这样：administrator@qf.com

   ![image.png](E:\MarkDown\markdown\imgs\b9000faa05ca1b17d5fcdaabd5a7fe2c.png)

   ![image.png](E:\MarkDown\markdown\imgs\eb44a379b96321a62c1e5d1d947420f6.png)

   ![image.png](E:\MarkDown\markdown\imgs\34629a8bd0b9e85c42df6d3a2625b5c1.png)
...
![image.png](E:\MarkDown\markdown\imgs\8b6b2fe9a0deca3b6cd4631539f93bb4.png)

![image.png](E:\MarkDown\markdown\imgs\ff61732be700834c56eb55fff0b175b4.png)

![image.png](E:\MarkDown\markdown\imgs\2cdc815397ee60f51b04228047adc7e5.png)

点击下一步，点击完成就可以看到Users里新加了一个用户

![image.png](E:\MarkDown\markdown\imgs\4e34ec46c806dbac3eef31a774185f7c.png)
...
![image.png](E:\MarkDown\markdown\imgs\376b3ce9f2ad5362942bf3097103f31a.png)

![image.png](E:\MarkDown\markdown\imgs\8c3ea41739e7d68aeed513b1158cd289.png)

如果点击确定弹出登录的话，以要添加的域用户登录

![image.png](E:\MarkDown\markdown\imgs\e15edbed6dc0f80bb9d851ba2e7bee65.png)
...
![image.png](E:\MarkDown\markdown\imgs\f8f1e6b2eb57726f9ce639ce64a20ea2.png)
...
![image.png](E:\MarkDown\markdown\imgs\98ec22e46c181873ced2fc8a40e1a544.png)
...
![image.png](E:\MarkDown\markdown\imgs\d642c377c9264e2beeba9a2b21c408ef.png)

![image.png](E:\MarkDown\markdown\imgs\069b28b85cec7eee8eb3927cdcc7eeaa.png)

查看组策略都做了哪些配置

点击要查看的组策略

![image.png](E:\MarkDown\markdown\imgs\fb81decac9be7c8198b0cba4761d3b26.png)

弹出的窗口点击添加

![image.png](E:\MarkDown\markdown\imgs\afa6f23e4f15e05f16a816f5db809011.png)

点击添加，点击关闭就OK

![image.png](E:\MarkDown\markdown\imgs\2a32b8b3d49f7fa295b10e5e623d0025.png)

![image.png](E:\MarkDown\markdown\imgs\66d11167791dd990e9e90193a08c5a8b.png)
...
![image.png](E:\MarkDown\markdown\imgs\a0632cf504434a60e1bf4831eaeb8737.png)

![image.png](E:\MarkDown\markdown\imgs\c44c20ad8aa773b959d99323b25c70c8.png)

![image.png](E:\MarkDown\markdown\imgs\ae3d5d3ebf912ec1a2b0b7e644e97943.png)

新建好组策略后，右键点击编辑，弹出，在用户配置下，点击

![image.png](E:\MarkDown\markdown\imgs\b96600464b496d94d661aeae836c785f.png)

![image.png](E:\MarkDown\markdown\imgs\d47811709f89313f661a650d1dd07188.png)
...
![image.png](E:\MarkDown\markdown\imgs\681326a0156b9b737ecce6d3140a5e28.png)

#### 测试4

![image.png](E:\MarkDown\markdown\imgs\250abff729c49156de05c70cbee4bc7a.png)

阻止继承后就有了一个感叹号！！

![image.png](E:\MarkDown\markdown\imgs\d45fe3963997a503939dc988bcebac3e.png)

#### 测试5

![image.png](E:\MarkDown\markdown\imgs\dc7048e26001d9d11eb6ea6d5b612379.png).

强制后就上了一把锁🔒

![image.png](E:\MarkDown\markdown\imgs\629e356e7b5fa4bb61ae0b44ba956854.png)

当上级OU强制之后，就算下级OU阻止继承也不管用，下级OU的组策略就失效了

#### 测试6

![image.png](E:\MarkDown\markdown\imgs\4937aaf5a01687df4ca478d619e91b82.png)

![image.png](E:\MarkDown\markdown\imgs\07dfffc22d67852a200953a1eaa988be.png)

## 12综合实训

![image.png](E:\MarkDown\markdown\imgs\ea086432016123eeca4f232252412930.png)
...
```xxxxxxxxxx1 19.要求用户必须使用443访问，不能使用80访问！
```
